          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-light/60 text-sm">5-Year Warranty</span>
              </div>
              
              <div className="flex items-center gap-2">
                <Users className="h-5 w-5 text-primary" />
                <span className="text-light/60 text-sm">1000+ Satisfied Customers</span>
              </div>
              
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary" />
                <span className="text-light/60 text-sm">Premium Quality Products</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
